...
The master branch uses Spring Cloud Pipelines. You can get most of the documentation for running these pipelines https://github.com/spring-cloud/spring-cloud-pipelines[here].
