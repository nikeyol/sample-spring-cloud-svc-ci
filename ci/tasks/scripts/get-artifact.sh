...
# wget -q -O sample-spring-cloud-svc-ci.jar "http://192.168.99.101:8081/service/local/repositories/releases/content/org/bk/sample-spring-cloud-svc-ci/1.1.0-rc.1/sample-spring-cloud-svc-ci-1.1.0-rc.1.jar"
